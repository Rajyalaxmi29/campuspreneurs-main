...
interface AuthContextType {
  ...
  loading: boolean;
  signUp: (email: string, password: string, name: string, department: string, year: string) => Promise<{ error: Error | null }>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signUp = async (email: string, password: string, name: string, department: string, year: string) => {
