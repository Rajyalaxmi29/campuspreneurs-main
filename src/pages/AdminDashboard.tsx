...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      const themeStatsData: ThemeStats[] = Object.entries(themeCountMap).map(([theme, count]) => ({
        theme,
        count: count as number
      }));
              ...
              <div className="bg-card rounded-xl p-6 shadow-card mt-8">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground">View and manage department problem statements</p>
                  </Link>
                  <Link
                    to="/events"
                    className="p-4 rounded-lg border border-border hover:border-secondary hover:bg-accent/50 transition-all"
