  ...
  return (
    <Layout>
      <PageHeader
        ...
        description="Explore real-world challenges across three distinct themes. Choose a problem that resonates with you and build innovative solutions."
        stats={
          <>
        ...
        actions={
          isAdmin ? (
            <Button onClick={openCreateDialog} variant="heroOutline">
      ...
      {/* Theme Cards */}
      <section className="py-12 bg-gcet-light">
                ...
                {filteredProblems.map((problem) => (
                  ...
                  >
                    <div className="flex flex-col lg:flex-row">
                      ...
                      {/* Actions */}
                      <div className="lg:w-auto p-4 lg:p-6 flex items-center justify-center gap-2 border-t lg:border-t-0 lg:border-l border-border bg-gcet-light/60">
                        {isAdmin && (
                          <>
                            <Button
                              variant="outline"
